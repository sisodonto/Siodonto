...
class Displaymsg_Core{
	...
	function msg($query){
		...
		$options = ['create', 'update', 'erro', 'delete'];
	...
	function danger($option){
		$msg = [
			'create' => 'Erro - Dados não foram cadastrados.',
			'delete' => 'Erro - Dados não foram excluídos.',
			'erro' => 'Um erro ocorreu.',
			'update' => 'Dados não atualizados'
		];
		$alert = '
